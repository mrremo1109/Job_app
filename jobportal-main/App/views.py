...
def chat_view(request):
    recruiters = Recruiter.objects.all()  # Or filter by relevant criteria
    return render(request, 'chat.html', {'recruiters': recruiters})

@login_required
def retrieve_chat_messages(request, receiver_id):
